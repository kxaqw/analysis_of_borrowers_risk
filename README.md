...
This project aims to explore the relationship between various socio-demographic factors and a borrower’s ability to repay a loan on time. Using real banking data on customer solvency, we will identify patterns that may influence loan default risk. The insights from this study will support the development of a credit scoring model — a tool that helps banks evaluate the reliability of loan applicants.
...
The project will be carried out in three main stages: <br>
<ul>
    <li>Data Review – assessing data quality and identifying anomalies or inconsistencies. </li>
